...
<body class="container col-lg-5 col-md-9 col-sm-12 box-shadow mx-auto" style="border-radius: 20px">

<main class="container rounded text-center ">
    <section id="loginSection">
        ...
        <form class="form-signin" method="post" enctype="multipart/form-data">
            ...
            <input type="text" id="loginUsername" name="loginUsername" class="form-control mb-2"
            ...
            <input type="password" id="loginPassword" name="loginPassword" class="form-control mb-2" placeholder="Password"
                   required>	
            <button class="btn btn-lg btn-primary btn-block mb-2" name="login" value="Login" type="submit">Login</button>
    ...
    <section id="registerSection" class="hidden">
        ...
        <form class="form-signin" method="post" enctype="multipart/form-data">
            ...
            <input type="text" id="registerUsername" name="registerUsername" class="form-control mb-2"
                   placeholder="Enter your username" required
                   autofocus>

            <label for="registerEmail" class="sr-only">Email address</label>
            <input type="email" id="registerEmail" name="registerEmail" class="form-control mb-2"
                   placeholder="Enter your email address" required
                   autofocus>

            <label for="registerPassword" class="sr-only">Password</label>
            <input type="password" id="registerPassword" name="registerPassword" class="form-control mb-2"
                   placeholder="Password" required>

            <label for="registerPasswordRepeat" class="sr-only">Password</label>
            <input type="password" id="registerPasswordRepeat" name="registerPasswordRepeat" class="form-control mb-2"
                   placeholder="Retype your Password"
                   required>
            <button class="btn btn-lg btn-primary btn-block mb-2" type="submit" name="register" id="register" value="register">Register</button>
